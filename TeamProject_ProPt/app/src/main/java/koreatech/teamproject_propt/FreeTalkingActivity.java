...
// 어떤 값을 선택했는지 토스트를 뿌려줌
                Toast.makeText(FreeTalkingActivity.this, adapterView.getItemAtPosition(i)+ " 클릭", Toast.LENGTH_SHORT).show();

// 게시물의 번호와 userid를 가지고 FreeTalkingRead 로 이동
                Intent intent = new Intent(FreeTalkingActivity.this, FreeTalkingRead.class);
...
// userid 를 가지고 FreeTalkingWriteActivity 로 이동
                Intent intent = new Intent(FreeTalkingActivity.this, FreeTalkingWriteActivity.class);
                intent.putExtra("userid", userid);
                startActivity(intent);
            }
        });
...
// ListView 에서 사용할 arrayAdapter를 생성하고, ListView 와 연결
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(FreeTalkingActivity.this, android.R.layout.simple_list_item_1, titleList);
